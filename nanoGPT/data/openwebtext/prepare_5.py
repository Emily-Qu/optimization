# prepare_openwebtext_5pct.py
# 采样 5% OpenWebText，生成 train_small.bin / val_small.bin
...
train_bin_file = os.path.join(out_dir, "train_small.bin")
val_bin_file = os.path.join(out_dir, "val_small.bin")
...
print("✅ Done! Small OpenWebText dataset ready.")
